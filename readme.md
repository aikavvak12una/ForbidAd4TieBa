...
在支持现代 libxposed api102 的框架中启用模块，并将作用域设置为：

`百度贴吧 com.baidu.tieba`

未root设备使用[NPatch](https://github.com/7723mod/NPatch)或其他支持现代 libxposed api102 的免root框架
...
- 信息流整理：支持按内容类型、关注状态、帖子模型评分和吧名关键词调整首页推荐内容。
- 界面布局精简：支持配置首页顶部 Tab、底部 Tab、进吧页面和帖子页部分界面元素。
- 浏览交互增强：提供评论自由复制、图片自动查看原图、系统分享入口、浏览时收起 Tab 栏等体验优化。
- 搜索与阅读辅助：支持收藏搜索、浏览历史搜索、信息流和帖子评论预加载。
- 个性化设置：支持外置浏览器打开链接、分享链接追踪参数清理、常用页面默认行为和背景主题配置。

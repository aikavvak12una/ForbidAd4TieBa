...
object UiText {
    object Settings {
        ...
        const val BLOCK_AD_POST_PAGE_DESC = "屏蔽帖子详情页列表广告、早插广告、广告请求、掉落广告和广告实验"
        ...
        const val BLOCK_AD_HOME_TOP_BAR_LABEL = "首页右上推广"
        const val BLOCK_AD_HOME_TOP_BAR_DESC = "隐藏首页右上游戏、提示和红点槽位"
        const val BLOCK_AD_MINE_TAB_WEB_LABEL = "我的页网页推广"
        const val BLOCK_AD_MINE_TAB_WEB_DESC = "隐藏我的页 Web 推广区块"
        const val BLOCK_AD_HOME_SIDE_BAR_WEB_LABEL = "首页侧边栏推广"

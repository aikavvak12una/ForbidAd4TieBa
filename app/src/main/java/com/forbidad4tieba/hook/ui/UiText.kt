...
object UiText {
    object Settings {
        ...
        const val HOME_NATIVE_GLASS_HOST_DARK_MODE_LABEL = "深色模式"
        const val HOME_NATIVE_GLASS_HOST_DARK_MODE_DESC = "切换此开关以提高文本可读性"
        const val HOME_NATIVE_GLASS_HOST_DARK_MODE_UNAVAILABLE = "无法调用应用深色模式接口"
        const val HOME_NATIVE_GLASS_HOST_DARK_MODE_FAILED = "应用深色模式切换失败"
